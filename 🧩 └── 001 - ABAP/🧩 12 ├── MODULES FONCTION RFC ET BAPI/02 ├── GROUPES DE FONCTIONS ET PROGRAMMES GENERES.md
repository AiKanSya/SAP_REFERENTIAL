# 2. GROUPES DE FONCTIONS ET PROGRAMMES GÉNÉRÉS
...
### 2.G.3 Étape 3 — Relever les données globales
...
### 2.G.4 Étape 4 — Vérifier le couplage
...
### 2.G.5 Étape 5 — Contrôler activation et transport

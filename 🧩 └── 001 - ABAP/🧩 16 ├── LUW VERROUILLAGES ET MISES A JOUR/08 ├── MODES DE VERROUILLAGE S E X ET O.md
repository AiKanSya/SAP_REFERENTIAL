# 8. MODES DE VERROUILLAGE `S`, `E`, `X` ET `O`
...
### 8.D.4 ÉTAPE 4 — TESTER LA MATRICE DE CONCURRENCE
...
### 8.D.5 ÉTAPE 5 — TESTER LE MODE OPTIMISTE AVEC SON CYCLE COMPLET
...
### 8.D.6 ÉTAPE 6 — VALIDER DANS `SM12`
...
## 8.H RÉFÉRENCES OFFICIELLES SAP

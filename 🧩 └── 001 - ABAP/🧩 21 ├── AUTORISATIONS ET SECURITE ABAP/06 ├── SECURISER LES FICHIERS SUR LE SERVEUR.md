...
### Étape 1 — Définir le périmètre du fichier
...
### Étape 2 — Configurer un nom logique dans `FILE`
...
### Étape 3 — Résoudre le nom physique avec l’API standard
...
### Étape 4 — Ouvrir le dataset dans un mode explicite
...
### Étape 5 — Traiter les erreurs et garantir la fermeture
...
### Étape 6 — Tester avec la configuration réelle

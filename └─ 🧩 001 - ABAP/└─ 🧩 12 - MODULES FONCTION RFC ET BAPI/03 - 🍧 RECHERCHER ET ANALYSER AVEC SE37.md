...
Dans un contexte où une logique doit être réutilisée localement ou appelée à distance tout en respectant son interface et sa transaction, le besoin consiste à **analyser, tester ou créer un module fonction avec une interface stable**. Cette notion est pertinente lorsque la modification ne doit intervenir qu’après identification du bon objet et de son impact.
...
- À l’issue du chapitre, le lecteur sait **analyser, tester ou créer un module fonction avec une interface stable**.

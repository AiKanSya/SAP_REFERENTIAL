...
- À l’issue du chapitre, le lecteur sait **utiliser api bal classique, api objet et code historique pour produire un journal applicatif retrouvable et exploitable par le support**.
...
➡️ [Chapitre suivant — PROGRAMMES DE DÉMONSTRATION, TESTS ET DIAGNOSTIC](<./23 - 🍧 PROGRAMMES DE DEMONSTRATION TESTS ET DIAGNOSTIC.md>)

...
Dans un contexte où une intervention de correction doit être réalisée dans le bon système et sur le bon objet sans affecter un environnement non autorisé, le besoin consiste à **écrire des instructions valides et exploiter l’aide contextuelle de la release**. Cette notion est pertinente lorsque le lecteur doit pouvoir relier la syntaxe ou l’outil à une situation professionnelle concrète.
...
- À l’issue du chapitre, le lecteur sait **écrire des instructions valides et exploiter l’aide contextuelle de la release**.
...
➡️ [Chapitre suivant — COMMENTAIRES ET CONVENTIONS](<./08 - 🍧 COMMENTAIRES ET CONVENTIONS.md>)

...
Dans un contexte où un besoin client doit compléter le comportement standard SAP sans modifier directement le code livré par SAP, le besoin consiste à **obtenir et interpréter le résultat attendu pour « rechercher un point d’extension »**. Cette notion est pertinente lorsque le lecteur doit pouvoir relier la syntaxe ou l’outil à une situation professionnelle concrète.
...
- À l’issue du chapitre, le lecteur sait **obtenir et interpréter le résultat attendu pour « rechercher un point d’extension »**.

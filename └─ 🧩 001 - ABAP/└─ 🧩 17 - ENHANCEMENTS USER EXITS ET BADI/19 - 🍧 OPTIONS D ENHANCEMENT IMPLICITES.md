...
- À l’issue du chapitre, le lecteur sait **utiliser options d’enhancement implicites pour étendre le standard sans créer de modification directe ni d’effet de bord hors périmètre**.

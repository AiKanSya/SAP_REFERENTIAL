...
- À l’issue du chapitre, le lecteur sait **utiliser badi classiques, filtres et usage multiple pour étendre le standard sans créer de modification directe ni d’effet de bord hors périmètre**.
...
➡️ [Chapitre suivant — ENHANCEMENT SPOTS ET IMPLÉMENTATIONS](<./17 - 🍧 ENHANCEMENT SPOTS ET IMPLEMENTATIONS.md>)

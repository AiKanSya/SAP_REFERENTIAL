...
Dans un contexte où un traitement de masse charge des commandes en mémoire, recherche des lignes, élimine des doublons et prépare un résultat, le besoin consiste à **ajouter des lignes dans une table Z en contrôlant les doublons et le résultat**. Cette notion est pertinente lorsque le lecteur doit pouvoir relier la syntaxe ou l’outil à une situation professionnelle concrète.
...
➡️ [Chapitre suivant — LIRE UNE LIGNE AVEC READ TABLE](<./06 - 🍧 LIRE UNE LIGNE AVEC READ TABLE.md>)

...
Dans un contexte où un traitement de masse charge des commandes en mémoire, recherche des lignes, élimine des doublons et prépare un résultat, le besoin consiste à **effectuer « supprimer, vider et libérer une table » en limitant l’action au périmètre prévu**. Cette notion est pertinente lorsque la suppression est destructive et doit être précédée d’une sélection et d’un contrôle explicites.
...
- À l’issue du chapitre, le lecteur sait **effectuer « supprimer, vider et libérer une table » en limitant l’action au périmètre prévu**.
...
➡️ [Chapitre suivant — TRIER ET ÉLIMINER LES DOUBLONS](<./12 - 🍧 TRIER ET ELIMINER LES DOUBLONS.md>)

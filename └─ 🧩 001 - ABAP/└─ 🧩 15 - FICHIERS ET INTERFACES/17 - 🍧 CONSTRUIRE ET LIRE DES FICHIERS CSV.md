...
Dans un contexte où SAP échange un fichier structuré avec une application externe et doit garantir format, encodage, sécurité et reprise, le besoin consiste à **produire ou lire un format délimité en gérant séparateurs, guillemets et encodage**. Cette notion est pertinente lorsque le programme doit distinguer résultat trouvé, résultat vide et erreur technique.
...
- À l’issue du chapitre, le lecteur sait **produire ou lire un format délimité en gérant séparateurs, guillemets et encodage**.

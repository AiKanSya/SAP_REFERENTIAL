...
Dans un contexte où un report doit lire ou mettre à jour des données en limitant le volume transféré et en conservant une transaction cohérente, le besoin consiste à **lire les enregistrements associés à une liste de clés sans provoquer une sélection complète**. Cette notion est pertinente lorsque le lecteur doit pouvoir relier la syntaxe ou l’outil à une situation professionnelle concrète.
...
- À l’issue du chapitre, le lecteur sait **lire les enregistrements associés à une liste de clés sans provoquer une sélection complète**.

...
Dans un contexte où un report doit lire ou mettre à jour des données en limitant le volume transféré et en conservant une transaction cohérente, le besoin consiste à **modifier uniquement les lignes prévues et vérifier le nombre de lignes concernées**. Cette notion est pertinente lorsque une modification trop large peut altérer des données ou des usages non prévus.
...
- À l’issue du chapitre, le lecteur sait **modifier uniquement les lignes prévues et vérifier le nombre de lignes concernées**.

...
Dans un contexte où un traitement récurrent et volumineux doit s’exécuter sans session utilisateur, laisser des traces et pouvoir être repris, le besoin consiste à **analyser méthodiquement « analyser les échecs et les retards » à partir d’un scénario reproductible**. Cette notion est pertinente lorsque la modification ne doit intervenir qu’après identification du bon objet et de son impact.
...
- À l’issue du chapitre, le lecteur sait **analyser méthodiquement « analyser les échecs et les retards » à partir d’un scénario reproductible**.

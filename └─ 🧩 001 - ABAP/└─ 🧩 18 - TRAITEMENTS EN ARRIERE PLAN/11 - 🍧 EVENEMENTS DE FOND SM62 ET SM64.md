...
- À l’issue du chapitre, le lecteur sait **configurer ou diagnostiquer événements de fond, `sm62` et `sm64` dans un traitement de fond traçable et relançable**.
...
➡️ [Chapitre suivant — DÉCLENCHER UN ÉVÉNEMENT EN ABAP](<./12 - 🍧 DECLENCHER UN EVENEMENT EN ABAP.md>)

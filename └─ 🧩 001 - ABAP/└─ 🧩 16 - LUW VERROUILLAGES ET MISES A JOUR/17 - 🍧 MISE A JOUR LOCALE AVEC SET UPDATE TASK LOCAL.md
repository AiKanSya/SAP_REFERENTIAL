...
- À l’issue du chapitre, le lecteur sait **appliquer mise à jour locale avec `set update task local` dans une transaction cohérente et vérifier verrous, validation et annulation**.

...
- À l’issue du chapitre, le lecteur sait **appliquer `_wait`, `_collect` et granularité des verrous dans une transaction cohérente et vérifier verrous, validation et annulation**.

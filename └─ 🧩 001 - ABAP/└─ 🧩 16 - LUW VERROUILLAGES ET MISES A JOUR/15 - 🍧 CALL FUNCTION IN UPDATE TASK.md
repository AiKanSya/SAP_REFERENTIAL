...
- À l’issue du chapitre, le lecteur sait **appliquer `call function ... in update task` dans une transaction cohérente et vérifier verrous, validation et annulation**.
...
➡️ [Chapitre suivant — MISES À JOUR `V1` ET `V2`](<./16 - 🍧 MISES A JOUR V1 ET V2.md>)

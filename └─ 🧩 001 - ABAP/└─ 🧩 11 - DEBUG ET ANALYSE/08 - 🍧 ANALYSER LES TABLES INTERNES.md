...
Dans un contexte où un incident ne se produit que pour certaines données et doit être reproduit puis localisé sans modifier le comportement métier, le besoin consiste à **analyser méthodiquement « analyser les tables internes » à partir d’un scénario reproductible**. Cette notion est pertinente lorsque la modification ne doit intervenir qu’après identification du bon objet et de son impact.
...
- À l’issue du chapitre, le lecteur sait **analyser méthodiquement « analyser les tables internes » à partir d’un scénario reproductible**.

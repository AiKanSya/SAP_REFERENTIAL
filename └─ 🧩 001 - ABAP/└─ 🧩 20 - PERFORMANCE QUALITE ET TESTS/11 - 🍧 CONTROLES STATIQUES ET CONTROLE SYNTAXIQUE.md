...
- À l’issue du chapitre, le lecteur sait **appliquer controles statiques et controle syntaxique pour mesurer, contrôler et sécuriser la qualité d’une livraison ABAP**.
...
➡️ [Chapitre suivant — EXTENDED PROGRAM CHECK AVEC SLIN](<./12 - 🍧 EXTENDED PROGRAM CHECK AVEC SLIN.md>)
